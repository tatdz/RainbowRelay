...
exports.ApiRelayer = exports.RelayClient = exports.getAdminApiUrl = exports.RelaySignerApiUrl = void 0;
...
const getAdminApiUrl = () => process.env.DEFENDER_API_URL || 'https://defender-api.openzeppelin.com/';
exports.getAdminApiUrl = getAdminApiUrl;
class RelayClient extends defender_base_client_1.BaseApiClient {
    ...
    getApiUrl(v = 'v1', type) {
        if (type === 'admin')
            return (0, exports.getAdminApiUrl)();
        if (v === 'v2') {
